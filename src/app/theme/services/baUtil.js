...
(function () {
    ...
    function baUtil() {
         ...
         * @param callback A callback called when the server responds.
         * @param type The request type (GET, POST). Defaults to 'GET'.
         * @param data Additional HTTP parameters. Defaults to an empty string.
         ...
         */
        this.ajax = function (url, callback, type, data) {
            // Trim everything!
            url = url.trim();
            type = type.trim();
